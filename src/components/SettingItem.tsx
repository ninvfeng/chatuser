  ...
  return (
    <div>
      ...
      <Show when={props.showSetting()}>
        <div class="my-4 shadow-2xl px-2 py-2 rounded">
          <div class="text-sm space-y-4 op-70">
            <div>
              <div class="flex">
                <svg
                  onClick={props.onRetry}
            ...
            <div>
              ...
              <a class="inline-flex items-center justify-center gap-1 text-sm  bg-slate/20 px-2 py-1 rounded-md transition-colors cursor-pointer hover:bg-slate/50" href="https://v.flomoapp.com/register/?NzQyMDE" target="_brank">注册浮墨笔记</a>
            </div>
          </div>
          <div class="flex space-x-2 op-70">
            <input
          ...
          <div class="mt-4 op-80">
            ...
            <div class="flex">
              <div onClick={() => { copyToClipboard(`${location.origin}?code=${props.user().share_code}`) }} class="mt-2 inline-flex items-center justify-center gap-1 text-sm  bg-slate/20 px-2 py-1 rounded-md transition-colors cursor-pointer hover:bg-slate/50">
                {`${location.origin}?code=${props.user().share_code}`}
              </div>
              <div onClick={() => { copyToClipboard(`${location.origin}?code=${props.user().share_code}`) }} class="mt-2 ml-2 inline-flex items-center justify-center gap-1 text-sm  bg-slate/20 px-2 py-1 rounded-md transition-colors cursor-pointer hover:bg-slate/50">
                复制
              </div>
            </div>
          </div>
